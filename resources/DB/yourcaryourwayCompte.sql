...
BEGIN
    ...
    INSERT INTO account (address_addressuuid, company_companyuuid, user_role_roleuuid, language_languageuuid, email, accountpassword, accountname, surname, phone, updatedat, createdat, active) VALUES (address_uuid, NULL, role_user_uuid,language_uuid, 'user@example.com', '$2a$10$/T0HZF.3NUxjJcUduu6DXOJ5NFQJTadHw51UH8nasNqvf7iTwxHwy', 'John', 'Doe', '1234567890', NOW(), NOW(), true);
    ...
    INSERT INTO account (address_addressuuid, company_companyuuid, user_role_roleuuid, language_languageuuid, email, accountpassword, accountname, surname, phone, updatedat, createdat, active) VALUES (address_uuid, company_uuid, role_employee_uuid, language_uuid, 'employee@example.com', '$2a$10$/T0HZF.3NUxjJcUduu6DXOJ5NFQJTadHw51UH8nasNqvf7iTwxHwy', 'Jane', 'Doe', '1234567890', NOW(), NOW(), true);
END $$;
